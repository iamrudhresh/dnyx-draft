    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#090d16] text-slate-900 dark:text-slate-100 transition-colors">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-8 py-12">
        ...
        <div className="space-y-8 text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">2. Open-Source &amp; Local-First Software</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">3. User Data Responsibility</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">4. Encryption Passwords</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">5. Disclaimer of Warranty</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">6. Organization &amp; Legal Entity</h2>
            <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0b0f19] space-y-1 text-xs">
              ...
              <div className="text-slate-500">Part of Dnyx Group</div>
            </div>
          </section>
        </div>
      </main>
