...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn('rounded-[var(--radius)] border border-border bg-card overflow-hidden', className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ...
    {...props}
  >
    <div className={cn('px-5 pb-5 pt-0 text-muted-foreground leading-relaxed border-t border-border/60', className)}>
      {children}
    </div>
  </AccordionPrimitive.Content>
));
