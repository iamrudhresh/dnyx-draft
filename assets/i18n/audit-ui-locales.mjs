...
const ALLOWED_IDENTICAL_TRANSLATIONS = {
  de: ['{{0}}m', '{{0}}m {{1}}s', '{{0}}s', 'Ab', 'Explorer', 'FAQ', 'h1, h2, h3, h4, h5, h6', 'HTML', 'JavaScript', 'Link', 'Markdown (.md)', 'Dnyx Draft', 'MD', 'Name', 'PDF', 'PNG', 'SVG', 'Dnyx Tech', 'Version', 'Wrap'],
  es: ['{{0}}m', '{{0}}m {{1}}s', '{{0}}s', 'Ab', 'Ctrl', 'h1, h2, h3, h4, h5, h6', 'HTML', 'JavaScript', 'Markdown (.md)', 'Dnyx Draft', 'MD', 'PDF', 'PNG', 'SVG'],
  fr: ['{{0}}m', '{{0}}m {{1}}s', '{{0}}s', 'Ab', 'Actions', 'Ctrl', 'Description', 'Destination', 'Documents', 'FAQ', 'h1, h2, h3, h4, h5, h6', 'HTML', 'Image (.png)', 'JavaScript', 'Markdown (.md)', 'Dnyx Draft', 'MD', 'Menu', 'Notifications', 'Participants', 'PDF', 'PNG', 'Session active', 'suggestion.', 'SVG', 'Version'],
  it: ['{{0}} file', '{{0}}m', '{{0}}m {{1}}s', '{{0}}s', '1 file', 'Ab', 'Backup', 'file', 'h1, h2, h3, h4, h5, h6', 'HTML', 'JavaScript', 'Markdown (.md)', 'Markdown file', 'Dnyx Draft', 'MD', 'PDF', 'PNG', 'SVG', 'Dnyx Tech', 'Wireframe'],
  ja: ['Ctrl', 'GitHub URL', 'HTML', 'JavaScript', 'Markdown (.md)', 'Dnyx Draft', 'MD', 'PDF', 'PNG', 'SVG'],
  ko: ['Ab', 'Ctrl', 'FAQ', 'GitHub URL', 'h1, h2, h3, h4, h5, h6', 'HTML', 'Markdown (.md)', 'Dnyx Draft', 'MD', 'PDF', 'PNG', 'SVG'],
  pl: ['{{0}}m', '{{0}}m {{1}}s', 'Ab', 'Ctrl', 'h1, h2, h3, h4, h5, h6', 'HTML', 'JavaScript', 'Link', 'Markdown (.md)', 'Markdown alert', 'Dnyx Draft', 'Menu', 'PDF', 'PNG', 'SVG'],
  pt: ['{{0}}m', '{{0}}m {{1}}s', '{{0}}s', 'Ab', 'Backup', 'Ctrl', 'h1, h2, h3, h4, h5, h6', 'HTML', 'item', 'JavaScript', 'Link', 'Markdown (.md)', 'Dnyx Draft', 'PDF', 'PNG', 'SVG', 'Dnyx Tech'],
  ru: ['Ctrl', 'h1, h2, h3, h4, h5, h6', 'HTML', 'JavaScript', 'Markdown (.md)', 'Dnyx Draft', 'PDF', 'PNG', 'SVG'],
  tr: ['{{0}}m {{1}}s', '{{0}}s', 'Ab', 'Ctrl', 'h1, h2, h3, h4, h5, h6', 'HTML', 'JavaScript', 'Markdown (.md)', 'Dnyx Draft', 'MD', 'PDF', 'PNG', 'Shift', 'SVG'],
  tw: ['Ab', 'Ctrl', 'HTML', 'JavaScript', 'Markdown (.md)', 'Dnyx Draft', 'MD', 'PDF', 'PNG', 'SVG'],
  uk: ['Ctrl', 'Git Graph', 'h1, h2, h3, h4, h5, h6', 'HTML', 'JavaScript', 'Markdown (.md)', 'Dnyx Draft', 'MD', 'PDF', 'PNG', 'Shift', 'SVG', 'Dnyx Tech'],
  zh: ['Ab', 'Ctrl', 'HTML', 'JavaScript', 'Markdown (.md)', 'Dnyx Draft', 'MD', 'PDF', 'PNG', 'SVG']
};
