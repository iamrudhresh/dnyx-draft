...
const PROTECTED_TERMS = [
  { pattern: /Dnyx Draft/g, token: '__MVTERM_DNYX_DRAFT__', value: 'Dnyx Draft' },
...
const EXTRA_STRINGS = [
  ...
  'Secure workspace files will remain encrypted in the backup. They can only be accessed after importing the backup into Dnyx Draft and unlocking them with the correct password.',
  "Clearing this site's browser data will delete local documents.",
  'Live Share', 'Report an issue', 'About Dnyx Draft', 'Workspace settings',
