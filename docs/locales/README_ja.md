<div align="center">
  ...
  <img src="../assets/icon.jpg" alt="Dnyx Draft のロゴ" width="100" />

  <h1>Dnyx Draft</h1>

  **ライブプレビューを備えた、ローカルファーストの Markdown エディター／ビューアー**

  ブラウザー、Progressive Web App（PWA）、Docker で Markdown を開き、編集、整理、レビュー、描画、エクスポートできます。必要に応じて共有や共同編集も利用できます。

  [![ライセンス](https://img.shields.io/github/license/dnyxtech/dnyx-draft?style=flat-square&color=red)](../LICENSE)
  [![最新リリース](https://img.shields.io/github/v/release/dnyxtech/dnyx-draft?style=flat-square&color=FF6B00)](https://github.com/dnyxtech/dnyx-draft/releases)

  <p>
    <a href="https://codewiki.google/github.com/dnyxtech/dnyx-draft" target="_blank" rel="noopener noreferrer">
      <img src="https://img.shields.io/badge/CodeWiki-Explore-4285F4?logo=wikipedia&logoColor=white&style=flat" alt="CodeWiki で Dnyx Draft を見る" />
    </a>
    <a href="https://deepwiki.com/dnyxtech/dnyx-draft" target="_blank" rel="noopener noreferrer">
      <img src="https://deepwiki.com/badge.svg" alt="DeepWiki で Dnyx Draft を見る" />
    </a>
  </p>

  [English](../README.md) · **日本語** · [한국어](README_ko.md) · [简体中文](README_zh.md) · [繁體中文](README_tw.md)

  [Web アプリを開く](https://draft.dnyxgroup.com/) · [ドキュメント（英語）](../wiki/Home.md) · [Issue を報告](https://github.com/dnyxtech/dnyx-draft/issues) · [リリース](https://github.com/dnyxtech/dnyx-draft/releases)
...
- [Dnyx Draft について](#dnyx-draft-について)
- [主な機能](#主な機能)
- [クイックスタート](#クイックスタート)
...
Dnyx Draft は、開発者、ライター、学生、研究者など、`.md`／`.markdown` ファイルを扱うすべての人に向けたオープンソースのローカルファーストワークスペースです。単なるプレーンテキストにとどまりません。複数の文書を整理し、Markdown を変更せずにコメントや提案でレビューし、図表、地図、チャート、数式、3D モデル、音楽をひとつの集中できるワークスペースで描画できます。
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/5a0d6fda-96f0-4baf-bf7a-0ffbe5119eab" alt="Dnyx Draft のアプリケーション画面" width="90%" />
</p>
...
- **バックアップと復元：** フォルダー構成を保持したワークスペース ZIP をエクスポートまたはインポートできます。Secret Workspace の暗号化済みファイルは任意で含められますが、ゴミ箱はバックアップに含まれません。
...
- **複数の提供形態：** ホスト済み Web アプリ、PWA、静的ホスティング、Docker、Cloudflare を利用できます。

実装済みの動作と制限は、[機能リファレンス（英語）](../wiki/Features.md)を参照してください。

## クイックスタート

[ホスト済み Web アプリ](https://draft.dnyxgroup.com/)を利用するか、リポジトリをローカル HTTP サーバーで起動します。
...
Dnyx Draft はローカルファーストですが、すべての機能がオフラインで動作するわけではありません。
...
- ワークスペースのバックアップには、ゴミ箱、クラッシュ復旧ジャーナルは含まれません。
...
Dnyx Draft を活用した以下のコミュニティプロジェクトは、各開発者によって独立して保守されています。
...
Dnyx Draft は、PC 上の小さな個人プロジェクトとして始まりました。好奇心を出発点に、失敗と修正を重ね、多くの配慮を込めて作られたシンプルな Markdown ビューアーです。初期バージョンは今もプロジェクトの原点であり続けています。

詳しい歴史は [Development Journey（英語）](../wiki/Development-Journey.md)をご覧ください。

## コントリビューター

Dnyx Draft は、コミュニティからのコントリビューションによって成長しています。

<a href="https://github.com/dnyxtech/dnyx-draft/graphs/contributors" target="_blank" rel="noopener noreferrer">
  <img src="https://contrib.rocks/image?repo=dnyxtech/dnyx-draft" alt="Dnyx Draft のコントリビューター" />
</a>

## コントリビューションとサポート

Pull Request を作成する前に、[Contributing（英語）](../wiki/Contributing.md)を確認してください。再現可能な不具合や明確な機能提案は [Issue Tracker](https://github.com/dnyxtech/dnyx-draft/issues) に報告できます。
...
Dnyx Draft は [Apache License 2.0](../LICENSE) で提供されています。
