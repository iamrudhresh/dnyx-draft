<div align="center">
  ...
  <img src="../assets/icon.jpg" alt="Dnyx Draft 로고" width="100" />

  <h1>Dnyx Draft</h1>

  **실시간 미리보기를 제공하는 로컬 우선 Markdown 편집기 및 뷰어**

  브라우저, 프로그레시브 웹 앱(PWA) 또는 Docker에서 Markdown을 열고 작성하고 정리하고 검토하고 렌더링하고 내보낼 수 있습니다. 필요한 경우 공유와 공동 편집도 사용할 수 있습니다.

  [![라이선스](https://img.shields.io/github/license/dnyxtech/dnyx-draft?style=flat-square&color=red)](../LICENSE)
  [![최신 릴리스](https://img.shields.io/github/v/release/dnyxtech/dnyx-draft?style=flat-square&color=FF6B00)](https://github.com/dnyxtech/dnyx-draft/releases)

  <p>
    <a href="https://codewiki.google/github.com/dnyxtech/dnyx-draft" target="_blank" rel="noopener noreferrer">
      <img src="https://img.shields.io/badge/CodeWiki-Explore-4285F4?logo=wikipedia&logoColor=white&style=flat" alt="CodeWiki에서 Dnyx Draft 살펴보기" />
    </a>
    <a href="https://deepwiki.com/dnyxtech/dnyx-draft" target="_blank" rel="noopener noreferrer">
      <img src="https://deepwiki.com/badge.svg" alt="DeepWiki에서 Dnyx Draft 살펴보기" />
    </a>
  </p>

  [English](../README.md) · [日本語](README_ja.md) · **한국어** · [简体中文](README_zh.md) · [繁體中文](README_tw.md)

  [웹 앱 열기](https://draft.dnyxgroup.com/) · [문서(영어)](../wiki/Home.md) · [이슈 보고](https://github.com/dnyxtech/dnyx-draft/issues) · [릴리스](https://github.com/dnyxtech/dnyx-draft/releases)
...
Dnyx Draft는 개발자, 작성자, 학생, 연구자 등 `.md` 또는 `.markdown` 파일을 사용하는 모든 사람을 위한 오픈 소스 로컬 우선 작업공간입니다. 단순한 텍스트를 넘어 여러 문서를 정리하고, Markdown을 변경하지 않은 채 댓글과 제안으로 검토하며, 다이어그램, 지도, 차트, 수식, 3D 모델, 음악을 하나의 집중된 작업공간에서 렌더링할 수 있습니다.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/5a0d6fda-96f0-4baf-bf7a-0ffbe5119eab" alt="Dnyx Draft 애플리케이션 화면" width="90%" />
</p>
...
- **백업 및 복원:** 폴더 구조를 유지하는 작업공간 ZIP을 내보내거나 가져올 수 있습니다. 암호화된 Secret Workspace 파일은 선택적으로 포함할 수 있지만 휴지통은 백업에 포함되지 않습니다.
...
- **다양한 실행 방식:** 호스팅 웹 앱, PWA, 정적 호스팅, Docker 또는 Cloudflare를 사용할 수 있습니다.

구현된 동작과 제한은 [기능 참고(영어)](../wiki/Features.md)를 확인하세요.

## 빠른 시작

[호스팅 웹 앱](https://draft.dnyxgroup.com/)을 사용하거나 로컬 HTTP 서버로 저장소를 실행합니다.
...
Dnyx Draft는 로컬 우선 애플리케이션이지만 모든 기능이 오프라인으로 작동하는 것은 아닙니다.
...
- 작업공간 백업에는 휴지통 또는 충돌 복구 저널이 포함되지 않습니다.
...
Dnyx Draft를 활용한 다음 커뮤니티 프로젝트는 해당 개발자가 독립적으로 유지 관리합니다.
...
Dnyx Draft는 PC에서 시작한 작은 개인 프로젝트였습니다. 호기심에서 출발해 실수와 수정을 거치고 많은 정성을 담아 만든 단순한 Markdown 뷰어입니다. 초기 버전은 지금도 프로젝트의 중심으로 남아 있습니다.

더 자세한 역사는 [Development Journey(영어)](../wiki/Development-Journey.md)를 참조하세요.

## 기여자

Dnyx Draft는 커뮤니티의 기여를 통해 성장하고 있습니다.

<a href="https://github.com/dnyxtech/dnyx-draft/graphs/contributors" target="_blank" rel="noopener noreferrer">
  <img src="https://contrib.rocks/image?repo=dnyxtech/dnyx-draft" alt="Dnyx Draft 기여자" />
</a>

## 기여 및 지원

Pull Request를 만들기 전에 [Contributing(영어)](../wiki/Contributing.md)을 읽어 주세요. 재현 가능한 버그와 구체적인 기능 제안은 [이슈 추적기](https://github.com/dnyxtech/dnyx-draft/issues)에 등록할 수 있습니다.
...
Dnyx Draft는 [Apache License 2.0](../LICENSE)에 따라 제공됩니다.
