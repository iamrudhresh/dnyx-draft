# Dnyx Draft Documentation

Dnyx Draft is a local-first Markdown editor and viewer for the web, Progressive Web App (PWA), Docker, and Cloudflare. It provides a plain-text Editor, sanitized Preview, Split view, a multi-Document Workspace, review tools, rich renderers, exports, Share Snapshot, and Live Share.
...
| Run the web app, PWA, Docker, or Cloudflare | [Installation](Installation.md) |
...
| :--- | :--- |
| Hosted web app | Open [draft.dnyxgroup.com](https://draft.dnyxgroup.com/) |
| PWA | Open the HTTPS site and use the browser's install action |
| Docker image | `docker run -d --name dnyx-draft -p 8080:80 ghcr.io/dnyxtech/dnyx-draft:latest` |
...
| Delivery | Static web, PWA, Docker, and Cloudflare |

## Privacy at a Glance

- Web documents are local per-document IndexedDB records.
